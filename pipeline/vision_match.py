...
def vision_rank_broll(
    ...
    prompt_text = (
        ...
        f"2. The clip must represent the general subject, device, concept, or process discussed in the narration or search query. "
        ...
        f"   - 90-100: exact subject or highly specific real-world match (clean footage, no text/logos)\n"
        f"   - 70-89: strong contextual/thematic match of the main subject (clean footage, no text/logos)\n"
        f"   - 50-69: usable fallback or generic filler related to the topic\n"
        f"   - 0-49: bad mismatch, text-heavy clip, title slide, black screen, or completely unrelated topic\n"
        f"4. Penalize clips showing:\n"
