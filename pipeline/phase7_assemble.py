...
def assemble_video(broll_files: list[str], tts_files: list[str], captions_ass: str, music_path: str, script: dict, format_type: str) -> str:
    ...
    for i, (broll_path, tts_path) in enumerate(zip(broll_files, tts_files)):
        ...
        # If the input B-roll is a local output video generated by Hyperframes,
        # we bypass the crop/zoom/pan/vignette filters to keep overlays intact.
        is_hyperframes = "output/broll_" in broll_path or "/output/broll_" in broll_path
